...
public:
    ...
    double vfov = 90;                  // Vertical Field of view or view angle
...
private:
    ...
    vec3 u, v, w; // camera frame basic vectors orthogonal on the viewport frame
    ...
    void initialize()
    {
        ...
        // calculate the u, v ,w unit basis vectors for the camera coordinates froma
